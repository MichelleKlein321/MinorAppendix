...
python /b06x-isilon/b06x-p/PanCanPredispo/2ndHitAnalysis/mklein/pa/Merge_snv_Germline.py --outf=/b06x-isilon/b06x-p/PanCanPredispo/2ndHitAnalysis/mklein/SNV/snv_pa_germline.vcf
