    ...
    if input == 'Gene1_exon':
        ...
        for line in infile:
            ...
            if len(List) == 3 or len(List) == 4:
                ...
                SV1_Gene_list.append(List[2])
            elif len(List) == 5 or len(List) == 6:
                SV1_Gene_list.append(List[0])
                SV1_Gene_list.append(List[1])
                SV1_Gene_list.append(List[2])
                SV1_Gene_list.append(List[4])
            elif len(List) == 7 or len(List) == 8:
                SV1_Gene_list.append(List[0])
                SV1_Gene_list.append(List[1])
                SV1_Gene_list.append(List[2])
                SV1_Gene_list.append(List[4])
                SV1_Gene_list.append(List[6])
        ...
        for j in Burden_Genes:
            if len(i) == 3:
                if i[2] == j:
                    ...
                    if i[2] not in Genes_result:
                        Burden_Genes_result.append(i[0]+',' + i[2])
                        # Burden_Genes_result.extend([i[2]])
            if len(i) == 4:
                if i[2] == j:
                    if i[1] not in Genes_result:
                        Genes_result.append(i[1])
                    if i[2] not in Genes_result:
                        Burden_Genes_result.append(i[0]+',' + i[2])
                        # Burden_Genes_result.append(i[0])
                        # Burden_Genes_result.append(i[2])
                if i[3] == j:
                    if i[1] not in Genes_result:
                        Genes_result.append(i[1])
                    if i[3] not in Genes_result:
                        Burden_Genes_result.append(i[0]+',' + i[3])
                        # Burden_Genes_result.append(i[0])
            ...
            if len(i) == 5:
                ...
                if i[4] == j:
                    if i[1] not in Genes_result:
                        Genes_result.append(i[1])
                    if i[4] not in Genes_result:
                        Burden_Genes_result.append(i[0]+',' + i[4])
                        # Burden_Genes_result.append(i[0])
                        # Burden_Genes_result.append(i[4])
